...
app.include_router(pagos_router, prefix="/pagos", tags=["Pago"])
app.include_router(pedidos_router, prefix="/pedidos", tags=["Pedido"])
app.include_router(direcciones_router, prefix="/direcciones", tags=["Direccion"])
